...
1. Sauté mode. Oil, then cumin seeds and fenugreek until they sizzle and darken, about 30 seconds.
2. Onions, a full 12 minutes — longer than the chana wants. Rajma has less acidity to hide behind, so the onion sweetness is doing more of the work. Take it to genuinely brown, not just soft.
