...
Cooked in double batches. Half this week, half flat-frozen for next.
...
The kit. Made on prep day, combined into dinners all week.
...
Make them in this order and you never wash the food processor bowl.
...
Assembly, not cooking. Wall clock first, hands-on second.
...
All assembled on the weekend. Zero weekday cost.
...
| Recipe | Yield | Time |
|---|---|---|
| [Post-Workout Breakfast Shake](breakfast-shake.md) | 1 | 2 min |

## Projects

| Recipe | Yield | Time |
|---|---|---|
| [Seitan, Three Flavors](project-seitan.md) | 12 | 2 hrs |

## Reference

| Recipe | Yield | Time |
|---|---|---|
| [Using Garden Tomatoes](reference-garden-tomatoes.md) | — | — |

---

Back to [the plan](../01-the-plan.md) · [the prep session](../02-prep-session.md) · [shopping](../04-shopping-list.md) · [nutrition](../05-nutrition.md)
