...
1. Whisk the dry ingredients, whisk the wet, then combine.
2. KNEAD 3-5 MINUTES — long enough to develop strands, not so long it turns rubbery. Rest 20 minutes.
3. Divide into three. Knead a different flavoring into each.
4. Wrap each tightly in foil, twisting the ends like a cracker.
5. STEAM 60-75 MINUTES. Steaming beats boiling — boiled seitan waterlogs.
6. COOL COMPLETELY BEFORE SLICING. The texture sets as it cools; slice it warm and it's spongy. Overnight in the fridge is better.
7. Slice thin, portion, freeze flat.
8. Reheats best seared hard in a dry-ish pan — it should get brown edges.
