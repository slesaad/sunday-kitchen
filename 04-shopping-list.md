...
Organized by store. **The first trip is the expensive one** — spices, sauces, and dry goods
last two to three months. After that the weekly list is short and mostly vegetables.

---

## First trip — pantry, lasts months

### Indian grocery

Everything here is a fraction of supermarket prices, and the spices are fresher.
...
| | |
|---|---|
| Light soy sauce, dark soy sauce | dark soy is for color in the chowmein |
| Rice vinegar | large |
| Toasted sesame oil | |
...
| | Why |
|---|---|
| **B12** — 250 mcg daily or 2,500 mcg weekly | Non-negotiable once dairy is gone. Check your multivitamin first. |
| **Algal DHA/EPA** — 250–500 mg daily | The real gap. No multivitamin contains it, and flax doesn't convert well. |
| **Vitamin D3** (vegan/lichen-derived) — 1,000–2,000 IU | Especially October through March. |
| **Iodized salt** | Sea salt and kosher salt contain none. Free fix — just buy the iodized one. |
| Creatine monohydrate | You already have it. 3–5 g/day, timing doesn't matter. |
...
| Scallions | 2 bunches |
| Cilantro, parsley | 1 bunch each — **2 of each on falafel weeks** |
| Pita or flatbread | falafel weeks only |
| Limes, lemons | 4 each |
...
Skip the weekly produce run down to just the fresh items — you'll still have anchors in
the freezer. Buy:
...
- **Dried beans over canned.** With an Instant Pot the convenience gap is about ten minutes
  and the cost gap is roughly 4×. Canned is a fine fallback on a bad week.
